...
export class ServicesComponent {
    public services : service[] = [
      ...
      {title: `SISTEMA\n
      DE REVOQUE`, description: ' en Seco o Estampillado', image: './assets/tdr/icons/5.svg'},
      {title:'CIELO RASO', description: ' en Panel de Yeso - Fibrocemento PVC', image: './assets/tdr/icons/10.svg'},
      {title:'MUROS', description: 'Panel yeso - Fibrocemento', image: './assets/tdr/icons/16.svg'},
